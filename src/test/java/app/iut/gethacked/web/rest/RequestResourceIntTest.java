...
public class RequestResourceIntTest {
    ...
    private static final Float DEFAULT_MAX_BUY_PRICE = 1F;
    private static final Float UPDATED_MAX_BUY_PRICE = 2F;
    ...
    public void createRequest() throws Exception {
        ...
        assertThat(testRequest.getMaxBuyPrice()).isEqualTo(DEFAULT_MAX_BUY_PRICE);
    ...
    public void getAllRequests() throws Exception {
        ...
        restRequestMockMvc.perform(get("/api/requests?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].maxBuyPrice").value(hasItem(DEFAULT_MAX_BUY_PRICE.doubleValue())))
    ...
    public void getRequest() throws Exception {
        ...
        restRequestMockMvc.perform(get("/api/requests/{id}", request.getId()))
            ...
            .andExpect(jsonPath("$.maxBuyPrice").value(DEFAULT_MAX_BUY_PRICE.doubleValue()))
    ...
    public void updateRequest() throws Exception {
        ...
        updatedRequest
            .maxBuyPrice(UPDATED_MAX_BUY_PRICE)
        ...
        Request testRequest = requestList.get(requestList.size() - 1);
        assertThat(testRequest.getMaxBuyPrice()).isEqualTo(UPDATED_MAX_BUY_PRICE);
